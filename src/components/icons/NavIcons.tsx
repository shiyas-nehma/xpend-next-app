...
export const PiggyBankIcon: React.FC<{ className?: string }> = ({ className }) => (
    <IconWrapper className={className}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 8.25v-1.5m0 1.5c-1.355 0-2.697.056-4.024.166C6.845 8.51 6 9.473 6 10.608v2.156c0 1.136.845 2.098 1.976 2.192A48.423 48.423 0 0012 15.25c1.355 0 2.697-.056 4.024-.166C17.155 14.962 18 14.027 18 12.892v-2.156c0-1.136-.845-2.098-1.976-2.192A48.423 48.423 0 0012 8.25z" />
          <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 10.608V14.25m4.5-3.642V14.25m4.5-3.642V6.357c0-1.223-.996-2.214-2.214-2.214H7.464C6.246 4.143 5.25 5.134 5.25 6.357v4.251" />
          <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 18.75h-4.5a.75.75 0 00-.75.75v2.25c0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75v-2.25a.75.75 0 00-.75-.75z" />
        </svg>
    </IconWrapper>
);
...
export const EyeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <IconWrapper className={className}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639l4.436-7.185a1.012 1.012 0 011.638 0l4.436 7.185a1.012 1.012 0 010 .639l-4.436 7.185a1.012 1.012 0 01-1.638 0l-4.436-7.185z" />
          <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
        </svg>
    </IconWrapper>
);
...
export const GridIcon: React.FC<{ className?: string }> = ({ className }) => (
    <IconWrapper className={className}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 8.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6A2.25 2.25 0 0115.75 3.75h2.25A2.25 2.25 0 0120.25 6v2.25a2.25 2.25 0 01-2.25 2.25h-2.25A2.25 2.25 0 0113.5 8.25V6zM13.5 15.75A2.25 2.25 0 0115.75 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z" />
        </svg>
    </IconWrapper>
);
...
export const GoogleIcon: React.FC<{ className?: string }> = ({ className }) => (
    <div className={`w-5 h-5 ${className}`}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
            ...
            <path fill="#4CAF50" d="M24,44c5.166,0,9.86-1.977,13.409-5.192l-6.19-5.238C29.211,35.091,26.715,36,24,36c-5.222,0-9.582-3.333-11.227-7.962H6.461v5.218C9.862,41.045,16.44,44,24,44z"/>
            <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.574l6.19,5.238C39.904,36.338,44,30.638,44,24C44,22.659,43.862,21.35,43.611,20.083z"/>
        </svg>
    </div>
);
...
export const FacebookIcon: React.FC<{ className?: string }> = ({ className }) => (
    <div className={`w-5 h-5 ${className}`}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
           ...
           <path fill="#fff" d="M26.572,29.036h4.917l0.772-4.995h-5.69v-2.73c0-2.075,0.678-3.915,2.619-3.915h3.119v-4.359c-0.582-0.074-1.682-0.14-2.557-0.14c-2.589,0-4.698,1.983-4.698,5.849v3.294h-4.09v4.995h4.09v12.237C25.078,42.4,26,42.128,26.572,29.036z"/>
        </svg>
    </div>
);
...
export const CheckCircleIcon: React.FC<{ className?: string }> = ({ className }) => (
    <IconWrapper className={className}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
          <path fillRule="evenodd" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12zm13.36-1.814a.75.75 0 10-1.06-1.06l-3.103 3.104-1.535-1.536a.75.75 0 00-1.06 1.06l2.064 2.065a.75.75 0 001.06 0l3.64-3.639z" clipRule="evenodd" />
        </svg>
    </IconWrapper>
);
...
export const InformationCircleIcon: React.FC<{ className?: string }> = ({ className }) => (
    <IconWrapper className={className}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
          <path fillRule="evenodd" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12zm8.7-4.243a.75.75 0 01.75-.75h.01a.75.75 0 01.75.75v.01a.75.75 0 01-.75.75h-.01a.75.75 0 01-.75-.75V7.757zm1.06 4.28a.75.75 0 00-1.06 0l-.64.64a.75.75 0 001.06 1.06l.11-.11v2.864a.75.75 0 001.5 0V12.5l.11.11a.75.75 0 001.06-1.06l-.64-.64z" clipRule="evenodd" />
        </svg>
    </IconWrapper>
);
...
export const StopSquareIcon: React.FC<{ className?: string }> = ({ className }) => (
  <IconWrapper className={className}>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
...
export const ChartLineIcon: React.FC<{ className?: string }> = ({ className }) => (
    <IconWrapper className={className}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" d="M2.5 19.5l4.333-4.333a2.25 2.25 0 013.182 0l2.365 2.365a2.25 2.25 0 003.182 0l4.333-4.333M3.75 3.75h16.5v16.5h-16.5z" />
        </svg>
    </IconWrapper>
);
...
export const LightBulbIcon: React.FC<{ className?: string }> = ({ className }) => (
    <IconWrapper className={className}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.311V21m-3.75 0h4.5M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
        </svg>
    </IconWrapper>
);
...
export const UsersIcon: React.FC<{ className?: string }> = ({ className }) => (
    <IconWrapper className={className}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-4.663M5.625 13.5a6.375 6.375 0 1112.75 0h-12.75z" />
        </svg>
    </IconWrapper>
);
